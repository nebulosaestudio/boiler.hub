...
class Stage{
		...
		drawMask()
		{
			ctx.drawImage(this.mask, 0, 0 , canvas_width , canvas_height );	
		...
		{
			this.w = window.innerWidth;
			this.h = screen.innerHeight;
			
			
			window.canvas_elem = document.getElementById("stage_canvas");
			window.canvas_elem.width = this.w;
			window.canvas_elem.height = this.h;
